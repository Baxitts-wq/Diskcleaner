...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  scanDeepClean: () => ipcRenderer.invoke('scan-deep-clean'),
  executeDeepClean: (items: string[]) => ipcRenderer.invoke('execute-deep-clean', items),
  ...
  scanThreats: () => ipcRenderer.invoke('scan-threats'),
  quarantineThreat: (threatId: string) => ipcRenderer.invoke('quarantine-threat', threatId),
